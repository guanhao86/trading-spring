$(function () {
    ...
    function n() {
        var pageTabs = $("#page_tabs").val();
        var pageTabsNumber = 10;
        if (pageTabs != ""){
            pageTabsNumber = parseInt(pageTabs);
        }
        var t = $(this).attr("href"), a = $(this).data("index"), i = $.trim($(this).text().replace(/\d+/g,'')), n = !0;
        if (void 0 == t || 0 == $.trim(t).length)return !1;
        var len = $(".J_menuTab").length;
        ...
        if ($(".J_menuTab").each(function () {
            ...
            if (len > pageTabsNumber){
                $.gritter.add({
                    title: "信息提示",
                    text: '打开的窗口太多，请先关闭一些窗口，谢谢！',
                    time: 2000
                })
                // shade.hideBg("dialog");
                return !1;
