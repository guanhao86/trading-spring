 ...
 **/
@Controller
@RequestMapping(Global.ADMIN_PATH + "/manage/bonusSetting/")
public class ManageBonusSettingController {
    ...
    public ModelAndView list(ModelAndView mav, HttpSession session, QueryVO queryVO, HttpServletRequest request,
        ...
        TableBonusSetting queryParam = new TableBonusSetting();
        BeanUtils.copyProperties(queryVO, queryParam);

        PageInfo<TableBonusSetting> pageInfo = this.iTableBonusSettingBusiSV.queryListPage(queryParam, page, pageSize, null);
        ...
        mav.setViewName("manage/bonusSetting/list");
        return mav;
    }
    ...
    public ModelAndView views(ModelAndView view, HttpServletRequest request, TableBonusSetting tableBonusSetting, String buttonType) {
        ...
        TableBonusSetting tableMember=this.iTableBonusSettingBusiSV.select(tableBonusSetting);
        view.addObject("bonusSetting",tableMember);
        view.setViewName("manage/bonusSetting/edit");
        return view;
    }
    //
    /*
    ...
    public ModelAndView edit(ModelAndView mav, HttpServletRequest request, TableBonusSetting tableBonusSetting) {
        Map map = Maps.newHashMap();
        map.put(Global.URL, Global.ADMIN_PATH +"/manage/bonusSetting/edit");
        this.iTableBonusSettingBusiSV.update(tableBonusSetting);

        PageResult.setPrompt(map,"操作成功", "success");
        return new ModelAndView(new RedirectView(Global.ADMIN_PATH +"/manage/bonusSetting/edit"), map);
    }
}
