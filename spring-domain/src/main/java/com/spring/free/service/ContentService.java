...
import com.spring.free.manager.ContentManager;
...
public class ContentService {
     ...
     **/
    public PageInfo<Content> pageList(Content content, Integer page, Integer pageSize){
        return manager.findList(content,page, pageSize);
    }
    public List<Content> getList(Content content){
        return manager.findList(content);
    }
    ...
    public void update(Content content){
        manager.updateBs(content);
    }
    public void update(Content content, MultipartFile postPic, Map map){
        ...
        content.setImage(imge);
        manager.updateBs(content);
    }
    /*新增*/
    public void insert(Content content){
        manager.insertBs(content);
    }
    public void delete(Content content){
        manager.deleteBs(content);
    }
    ...
    public void insert(Content content,MultipartFile postPic,Map map){
        String imge = upload(postPic);
        System.out.print(imge);
        if(imge==null){
            throw new ServiceException(ExceptionCodeEnum.SERVICE_ERROR_CODE.getCode(), "更新图片信息失败", map.get(Global.URL).toString(), map);
...
//        browse.setPostId(post.getId());
//        browse.setUserId("admin");
//        browseMapper.insertBs(browse);
    }
}
